...
FIRST_MAP_WITH_GUN <- "1950_firstportal"
FIRST_MAP_WITH_UPGRADE_GUN <- "1950_firstportal"
FIRST_MAP_WITH_POTATO_GUN <- "1950_firstportal"
LAST_PLAYTEST_MAP <- "glados_finale"


CHAPTER_TITLES <- 
[
	{ map = "intro_aperture_facility", title_text = "#portal2_Chapter1_Title", subtitle_text = "#portal2_Chapter1_Subtitle", displayOnSpawn = true,		displaydelay = 1.0 },
	{ map = "1950_intro", title_text = "#portal2_Chapter2_Title", subtitle_text = "#portal2_Chapter2_Subtitle", displayOnSpawn = true,	displaydelay = 2.5 },
	{ map = "1960_intro", title_text = "#portal2_Chapter3_Title", subtitle_text = "#portal2_Chapter3_Subtitle", displayOnSpawn = true,	displaydelay = 2.5 },
	{ map = "1970_intro", title_text = "#portal2_Chapter4_Title", subtitle_text = "#portal2_Chapter4_Subtitle", displayOnSpawn = true, displaydelay = 2.5 },
	{ map = "1980_intro", title_text = "#portal2_Chapter5_Title", subtitle_text = "#portal2_Chapter5_Subtitle", displayOnSpawn = true,			displaydelay = 1.0 },
	{ map = "newaperture_intro", title_text = "#portal2_Chapter6_Title", subtitle_text = "#portal2_Chapter6_Subtitle", displayOnSpawn = true,			displaydelay = 1.5 },
	{ map = "glados_awaken", title_text = "#portal2_Chapter7_Title", subtitle_text = "#portal2_Chapter7_Subtitle", displayOnSpawn = true,	displaydelay = 1.0 },
]
...
// 	1940
// ---------------------------------------------------
"intro_aperture_facility",		// enter aperture
"intro",	
...
"1940_faithplate",
	"@test_dome_lift",		// fling with old faith plate
"1940_faithplate2",	
	"@test_dome_lift",		// fling some more
"1940_testingtrack_new",
	"@test_dome_lift",		// enter a new testing track
"1940_newgel",				
	"@test_dome_lift",            // first gel level 
